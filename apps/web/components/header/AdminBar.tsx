...
export default function AdminBar(): JSX.Element {
  ...
  function shortenHexString(hexString: string, startLength: number, endLength: number) {
        ...
        {status === 'connected' && (
          <div className="popup-user">
            <Image
              ...
              width={100}
            />
            <div className={`avatar_popup mt-20 ${isAuthorActive ? 'visible' : ''}`}>
              ...
              <div className="links mt-20">
                <Link className="mt-10" href="/invite-friend">
                ...
                <a className="mt-10" href="#" onClick={() => {}}>
                  <svg fill="none" height={20} viewBox="0 0 20 20" width={20} xmlns="http://www.w3.org/2000/svg">
                    <path
