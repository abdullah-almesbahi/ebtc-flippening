export default function SellShareModal(): JSX.Element {
  return (
    <div aria-hidden="true" aria-labelledby="dialog" className="modal fade popup" id="popup_sell_share" tabIndex={-1}>
